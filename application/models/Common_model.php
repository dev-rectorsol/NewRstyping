...
class Common_model extends CI_Model {
    ...
    function edit_option($action, $id, $table){
		...
		function get_lesson( $id, $table){

			  $this->db->select('lessonDesc');
    ...
    // select all enquiry data

    function selectEnquiry($table){
    ...
    function upload_image($max_size = 2048){
