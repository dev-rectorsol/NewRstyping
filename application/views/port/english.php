<?php include('layout/css.php'); ?>
    ...
    <section>
      ...
      <div>
        <select class="" name="testTime" id="testTime" onchange="paragraph(this.value)" style="padding: 8px; background: #fff; width: 20%;">
        ...
        <select class="" name="modeId" id="modeId" onchange="paragraph(this.value)" style="padding: 8px; background: #fff; width: 20%;">
    ...
    <section id="type-section">
        ...
        <div id="timer" class="type-btn"><span id = "duration"><?php echo $time; ?></span></div>
