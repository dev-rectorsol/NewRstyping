            ...
            <div class="tab-pane fade show active" id="business-1" role="tabpanel" aria-labelledby="business-tab">
              <div class="row">
                <div class="col-xl-3 col-lg-6 col-sm-6 grid-margin stretch-card">
                  <div class="card">
                    <div class="card-body text-center">
                      <a href="#"><h5 class="mb-2 text-dark font-weight-normal">Total Visiter</h5></a>
                      <h2 class="mb-4 text-dark font-weight-bold"><?php echo $allVisiter ?></h2>
                    </div>
                  </div>
                </div>
                <div class="col-xl-3 col-lg-6 col-sm-6 grid-margin stretch-card">
                  <div class="card">
                    <div class="card-body text-center">
                      <a href="<?php echo base_url('admin/course'); ?>"><h5 class="mb-2 text-dark font-weight-normal">All Courses</h5></a>
                      <h2 class="mb-4 text-dark font-weight-bold"><?php echo $courses ?></h2>
                ...
                <div class="col-xl-3  col-lg-6 col-sm-6 grid-margin stretch-card">
                  <div class="card">
                    <div class="card-body text-center">
                      <a href="<?php echo base_url('admin/lesson'); ?>"><h5 class="mb-2 text-dark font-weight-normal">All Lesson</h5></a>
                      <h2 class="mb-4 text-dark font-weight-bold"><?php echo $lesson ?></h2>
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 grid-margin stretch-card">
                  <div class="card">
                    <div class="card-body text-center">
                      <a href="<?php echo base_url('admin/dashboard/enquiry'); ?>"><h5 class="mb-2 text-dark font-weight-normal">All Contact</h5></a>
                      <h2 class="mb-4 text-dark font-weight-bold"><?php echo $contact ?></h2>
